                          ...
                          <table>
                            <tr>
                              <th>
                                ...
                                <center data-parsed=""> <img src="<?= base_url('assets/img/logos/gl.jpg') ?>" align="center" class="float-center"> </center>
                                <table class="spacer">
                                  <tbody>
                                    <tr>
                                      <td height="16px" style="font-size:16px;line-height:16px;">&#xA0;</td>
                                ...
                                <h4>Hemos creado una cueta en el sistema para ti.</h4>
                                ...
                                <br>
                                <p>Resguarda estos datos ya que son intranferibles</p>
                                    ...
                                    <tr>
                                      <td>
                                        <table>
                                          <tbody>
                                            <tr>
                                              <td>                                <a href="<?= base_url('login') ?>">Ir al login</a></td>
                                            </tr>
                                          </tbody>
                                        </table>
                                      </td>
